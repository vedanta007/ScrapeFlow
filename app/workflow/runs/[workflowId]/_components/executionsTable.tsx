            ...
            <Table className='h-full'>
                ...
                <TableBody className='gap-2 h-full overflow-auto'>
                    {query.data.map((execution) => {
                        ...
                        const formatStartedAt = execution.startedAt && formatDistanceToNow(execution.startedAt, {addSuffix: true})
                        return (
                                ...
                                <TableCell>
                                    <div className='flex flex-col'>
                                        <div className='flex gap-2 items-center'>
                                            ...
                                            <span className="font-semibold capitalize">{execution.creditsCost}</span>
                                        </div>
