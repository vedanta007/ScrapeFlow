        ...
        return (
            <Card className='w-full p-4'>
                <div className='flex flex-col items-center gap-4 justify-center'>
                    <div className='rouded-full bg-accent w-20 h-20 flex items-center justify-center'>
                        <ShieldIcon size={40} className='stroke-primary' />
                    </div>
                    <div className='text-center flex flex-col gap-1'>
                        <p className='text-bold'>No credentials created yet</p>
                        <p className='text-sm text-muted-foreground'>Click the button below to create new credential</p>
                    </div>
